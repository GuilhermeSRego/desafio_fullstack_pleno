...
Entregáveis
Repositório Git público com histórico de commits que mostre como o trabalho evoluiu
docker compose up deve subir a aplicação completa sem configuração adicional
README atualizado cobrindo:
Como rodar o projeto localmente
Decisões arquiteturais e trade-offs
Credenciais de teste
O que faria diferente com mais tempo
Envio: responda ao e-mail de convite com o link do repositório (ou deploy público)
...
armazene os dados em banco de dados postgresDB;

crie um readme documentando tudo conforme o 
prompt